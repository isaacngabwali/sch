          ...
          <div className="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
            ...
            >
              <span className="text-yellow-500">
                Simplify workflows, Automate tasks
              </span>{" "}
              and Optimize your school’s performance.
            </h1>
            <p
              data-aos="fade-down"
              data-aos-once="true"
            ...
            >
              The only <span className="text-yellow-500">software</span> you
              need to run your <span className="text-yellow-500">school.</span>
            </p>
            <div
              data-aos="fade-up"
              data-aos-once="true"
      ...
      <div className="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
        ...
        <div data-aos="flip-up" className="max-w-xl mx-auto text-center mt-24">
          <h1 className="font-bold text-darken my-3 text-2xl">
            All-In-One{" "}
            <span className="text-yellow-500">School Management Software.</span>
          </h1>
          <p className="leading-relaxed text-gray-500">
            SchoolX is a powerful School Management Software suite that combines
            all the tools needed to run a successful school.
          </p>
        </div>
        {/* card */}
        <div className="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              Manage all your student Bio data, parents data, Accommodation
              programs, School Attendance,Discipline, and so much more
            </p>
          </div>
          <div
            data-aos="fade-up"
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              Enjoy amazing features like digitalized record keeping,
              performance analysis , report card generation for both new & Old
              Curriculum
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              Monitoring which students and staff members have entered your
              premises has never been simpler. Silence the worries of the
              parents that entrust you with there kids with daily notifications
              when their child arrives at or departs from school
            </p>
          </div>
        </div>
        <div className="grid md:grid-cols-2 gap-14 md:gap-5 mt-20">
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              Send text messages to any selection of parents with ease or with a
              single click{" "}
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              Parents and Guardians can log into the system to access their
              children’s academic , disciplinary or financial records{" "}
            </p>
          </div>
        </div>
        {/* lorem */}
        <div className="mt-28">
          ...
          >
            <h1 className="text-3xl font-bold mb-4">
              SchoolX{" "}
              <span className="text-yellow-500">for Parents and Students</span>
            </h1>
          </div>
          <div
            data-aos="fade-up"
          ...
          <div data-aos="fade-right" className="sm:w-1/2 relative">
            ...
            <div>
              <div className="flex items-center space-x-5 my-5">
                ...
                <p>
                  <span className="text-yellow-500">Fast Working Process</span>
                  <br />
                  We can migrate your data and have you running in less than a
                  week.
                </p>
              </div>
              <div className="flex items-center space-x-5 my-5">
                ...
                <p>
                  <span className="text-yellow-500">24/7 Hours S</span>
                  <br />
                  We are with you every step of the way and help you overcome
                  any huddles you may come across.
                </p>
              </div>
              <div className="flex items-center space-x-5 my-5">
                <div className="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
                ...
                <p>
                  <span className="text-yellow-500">Communication Portal</span>
                  <br />
                  Making public communication to parents has been made easier in
                  a few clicks send email or SMS communications concerning
                  school programs, students welfare, etc.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="md:flex mt-40 md:space-x-10 items-start">
          ...
          >
            <div className="flex items-center space-x-5 my-5">
              ...
              <p>
                <span className="text-yellow-500">Access Control</span>
                <br />
                One of our the most in-demand features indeed!. Monitor when
                your day scholars are picked up or dropped off by the school
                shuttle, and when they arrive or depart from school premises all
                the while promptly notifying their guardians to subdue their
                worries.
              </p>
            </div>
            <div className="flex items-center space-x-5 my-5">
            ...
            <div className="flex items-center space-x-5 my-5">
              ...
              <p>
                <span className="text-yellow-500">24/7 Hours S</span>
                <br />
                We are with you every step of the way and help you overcome any
                huddles you may come across.
              </p>
            </div>
          </div>
        </div>
